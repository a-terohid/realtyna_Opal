...
export async function generateMetadata(props: Props): Promise<Metadata> {
  ...
  return {
    title: `Homes & Real Estates | ${siteName}`,
    description: `Search ${listings["@odata.count"]} homes for sale and find your perfect home today! View listing photos, Review property details, and Contact a ${siteName} agent for more information. `
  }
}
