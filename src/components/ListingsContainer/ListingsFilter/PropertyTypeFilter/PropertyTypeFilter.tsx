...
import { mdiChevronDown, mdiCity } from "@mdi/js"
...
import PropertyTypeFilterContent from "./PropertyTypeFilterContent"
...
const PropertyTypeFilter: React.FC<IProps> = ({
  isHome = false,
  urlSearchParams,
  setUrlSearchParams
}) => {
    ...
    <Popover>
      <PopoverTrigger
        className={cn(
          ...
          isHome
            ? "w-full border-black/20 bg-white text-black/80 sm:w-auto"
